...
public partial class Monsters
{
  ...
  {
    var f = _MBaseBuilderUtils.family("B");
    f.groups("bird");
    f.sense(see: 8, hear: 6);
    f.defense(10, "{1} flaps out of the way.");
    f.fly();
    f.count(3, 6);
    var b = _MBaseBuilderUtils.breed("crow", 4, Hues.darkCoolGray, 7, speed: 2, meander: 30);
    b.attack("bite[s]", 5);
    b.drop("treasure", percent: 10);
    _MBaseBuilderUtils.describe("\"What harm can a stupid little crow do?\" you think as it and its murderous friends dive towards your eyes, claws extended.");

    b = _MBaseBuilderUtils.breed("raven", 6, Hues.coolGray, 16, meander: 15);
    b.attack("bite[s]", 5);
    b.attack("claw[s]", 4);
    b.drop("treasure", percent: 10);
    b.flags("protective");
    _MBaseBuilderUtils.describe("It's black eyes gleam with a malevolent intelligence.");
  }
  ...
  public static void faeFolk()
  {
    ...
    var f = _MBaseBuilderUtils.family("F", speed: 2, meander: 30, flags: "cowardly");
    f.groups("fae");
    f.sense(see: 10, hear: 8);
    f.defense(10, "{1} flits out of the way.");
    f.fly();
    f.preferOpen();
    var b = _MBaseBuilderUtils.breed("forest sprite", 2, Hues.mint, 6);
    ...
    b = _MBaseBuilderUtils.breed("house sprite", 5, Hues.lightBlue, 10);
    b.attack("poke[s]", 5);
    b.missive(Missive.insult, rate: 4);
    ...
    b = _MBaseBuilderUtils.breed("mischievous sprite", 7, Hues.pink, 24);
    b.attack("poke[s]", 6);
    b.missive(Missive.insult, rate: 4);
    ...
    b = _MBaseBuilderUtils.breed("Tink", 8, Hues.peaGreen, 40, meander: 10);
    b.she();
    b.attack("poke[s]", 8);
    b.missive(Missive.insult, rate: 4);
  ...
  {
    var f = _MBaseBuilderUtils.family("H");
    f.groups("hybrid");
    f.sense(see: 10, hear: 12);

    // TODO: Cause disease when scratched?
    var b = _MBaseBuilderUtils.breed("harpy", 25, Hues.lilac, 50, speed: 2);
    b.fly();
    b.count(2, 5);
    b.attack("bite[s]", 10);
    ...
    b = _MBaseBuilderUtils.breed("griffin", 35, Hues.gold, 200);
    b.attack("bite[s]", 20);
    b.attack("scratch[es]", 15);
  ...
  {
    // TODO: Better group?
    var f = _MBaseBuilderUtils.family("Q");
    f.groups("magical");
    var b = _MBaseBuilderUtils.breed("Nameless Unmaker", 100, Hues.purple, 1000, speed: 2);
  ...
  {
    var f = _MBaseBuilderUtils.family("R");
    f.groups("herp");
    var b = _MBaseBuilderUtils.breed("frog", 1, Hues.lima, 4, dodge: 30, meander: 30);
    b.sense(see: 6, hear: 4);
    b.swim();
    b.attack("hop[s] on", 2);

    f = _MBaseBuilderUtils.family("R", dodge: 30, meander: 20);
    f.groups("salamander");
    f.sense(see: 6, hear: 5);
    f.preferOpen();
    f.emanate(3);
    b = _MBaseBuilderUtils.breed("juvenile salamander", 7, Hues.pink, 20);
    b.attack("bite[s]", 14, Elements.fire);
    b.fireCone(rate: 16, damage: 20, range: 4);

    b = _MBaseBuilderUtils.breed("salamander", 13, Hues.red, 30);
    b.attack("bite[s]", 18, Elements.fire);
    b.fireCone(rate: 16, damage: 30, range: 5);

    b = _MBaseBuilderUtils.breed("three-headed salamander", 23, Hues.maroon, 90);
  ...
  {
    var f = _MBaseBuilderUtils.family("S", dodge: 30, meander: 30);
    f.groups("snake");
    f.sense(see: 4, hear: 7);
    var b = _MBaseBuilderUtils.breed("water snake", 1, Hues.lima, 9);
    b.attack("bite[s]", 3);

    b = _MBaseBuilderUtils.breed("brown snake", 3, Hues.tan, 25);
    b.attack("bite[s]", 4);

    b = _MBaseBuilderUtils.breed("cave snake", 8, Hues.lightCoolGray, 40);
    b.attack("bite[s]", 10);
  }

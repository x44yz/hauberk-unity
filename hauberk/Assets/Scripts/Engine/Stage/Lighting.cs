...
public class Lighting
{
  ...
  public Array2D<int> _floorLight;
  ...
  public Array2D<int> _actorLight;

  public Fov _fov;
  public BucketQueue<Vec> _queue = new BucketQueue<Vec>();
  ...
  public void refresh()
  {
    ...
    if (_visibilityDirty && !Debugger.debugHideFog) _fov.refresh(_stage.game.hero.pos);
